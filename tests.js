 ...
 */
var exitWithCode = function (code) { return process.exit(code); };
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var t, i, r;
        return __generator(this, function (_a) {
            t = timer.timeout(1000, function () { return console.log('test'); });
            i = timer.interval(1000, function () { return console.log('test'); });
            r = timer.immediate(function () { return console.log('test'); });
            try {
